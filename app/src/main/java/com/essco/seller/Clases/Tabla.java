...
public class Tabla
{
     ...
     * @param tabla TableLayout donde se pintar? la tabla
     */
    ...
    /**
     * Devuelve el n?mero de celdas de la tabla, la cabecera se cuenta como fila
     * @return N?mero de celdas totales de la tabla
     */
    ...
    /**
     * Obtiene el ancho en p?xeles de un texto en un String
     * @param texto Texto
     * @return Ancho en p?xeles del texto
     */
